...
# IMAGES
# keep_locally = true : plusieurs environnements partagent la même image locale.
# Sans ça, détruire un environnement supprimerait l'image encore utilisée par l'autre.
